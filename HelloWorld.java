...
public class HelloWorld {
  ...
  public static void main(String[] args) {
    ...
    public static void doubleNumber1(int value)
    {
      ...
      CompareTo is use to compare Strings Rational Operator
      */
      ...
      int original_result = results;

      results = results - 1;
      // result is now 2
      System.out.println(original_result + " - 1 = " + results);
      original_result = results;

      results = results * 2;
      // result is now 4
      System.out.println(original_result + " * 2 = " + results);
      original_result = results;
      ...
      results = results + 8;
      // result is now 10
      System.out.println(original_result + " + 8 = " + results);
      original_result = results;

      results = results % 7;
      // result is now 3
      System.out.println(original_result + " % 7 = " + results);
      // Increment ++
      int i = 3;
      i++;
      // prints 4
    ...
    //While Loop
      ...
      System.out.println( (t.length() - dot - 1) +
          " digits after decimal point.");
   // Break is a java statement that when executed inside a loop the loop statement is terminated immediately
  int o = 0;
  while (o<10) {
...
System.out.println(al);//prints []
    ...
    another class is called a subclass, whereas the class from which 
    a subclass is derived is called a superclass.One of the key 
    benefits of inheritance is to minimize the amount of duplicate 
    code in an application by sharing common code amongst several 
    subclasses.*\ 
  ...
  // TODO Auto-generated method stub
    ...
    // TODO Auto-generated method stub
      ...
      private static void doubleNumber(int integer) {
    // TODO Auto-generated method stub
